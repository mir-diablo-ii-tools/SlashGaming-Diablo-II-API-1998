...
ASM_X86_LABEL(CallEsicallFunction_PushStackArgsLoop);
  ASM_X86(cmp ecx, 2);
  ASM_X86(jl CallEsicallFunction_PushStackArgsLoopEnd);

  ASM_X86(push dword ptr [eax]);
  ASM_X86(sub ecx, 1);
  ASM_X86(sub eax, 4);
  ASM_X86(jmp CallEsicallFunction_PushStackArgsLoop);
ASM_X86_LABEL(CallEsicallFunction_PushStackArgsLoopEnd);
