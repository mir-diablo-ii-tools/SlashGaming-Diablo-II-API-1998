...
static void* Mdc_MapStringGameAddressLocator_InitEmptyAsVoid(
    void* obj
) {
  return Mdc_MapStringGameAddressLocator_InitEmpty(obj);
}

static void Mdc_MapStringGameAddressLocator_InitGlobalObjectMetadata(void) {
  object_metadata = *Mdc_Map_GetObjectMetadataTemplate();

  object_metadata.functions.init_default =
      &Mdc_MapStringGameAddressLocator_InitEmptyAsVoid;
}

static void Mdc_MapStringGameAddressLocator_InitGlobalMapMetadata(void) {
...
static void InitStatic(void) {
  call_once(
      ...
      &Mdc_MapStringGameAddressLocator_InitGlobalObjectMetadata
  );

  call_once(
      &map_metadata_init_flag,
      &Mdc_MapStringGameAddressLocator_InitGlobalMapMetadata
  );
}
...
struct Mdc_Map* Mdc_MapStringGameAddressLocator_InitEmpty(
    struct Mdc_Map* map
) {
  InitStatic();
...
Mdc_MapStringGameAddressLocator_GetObjectMetadata(void) {
  InitStatic();
...
Mdc_MapStringGameAddressLocator_GetMapMetadata(void) {
  InitStatic();
