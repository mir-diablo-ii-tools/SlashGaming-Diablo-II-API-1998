...
#ifndef SGMAPI_C_BACKEND_GAME_ADDRESS_TABLE_PAIR_STRING_GAME_ADDRESS_LOCATOR_H_
#define SGMAPI_C_BACKEND_GAME_ADDRESS_TABLE_PAIR_STRING_GAME_ADDRESS_LOCATOR_H_
...
#endif /* SGMAPI_C_BACKEND_GAME_ADDRESS_TABLE_PAIR_STRING_GAME_ADDRESS_LOCATOR_H_ */
