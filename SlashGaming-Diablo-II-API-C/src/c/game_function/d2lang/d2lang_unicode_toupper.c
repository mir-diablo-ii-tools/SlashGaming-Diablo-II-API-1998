...
#include "../../../../include/c/game_function/d2lang/d2lang_unicode_toupper.h"
...
struct D2_UnicodeChar* D2_D2Lang_Unicode_toupper(
  ...
  return (struct D2_UnicodeChar*) D2_D2Lang_Unicode_toupper_1_00(
      actual_src,
      actual_dest
  );
}

struct D2_UnicodeChar_1_00* D2_D2Lang_Unicode_toupper_1_00(
    const struct D2_UnicodeChar_1_00* src,
    struct D2_UnicodeChar_1_00* dest
) {
