...
#include "../../../../include/sgd2mapi98/game_variable/d2client/d2client_is_automap_open.h"
...
int D2_D2Client_GetIsAutomapOpen(void) {
  InitStatic();

  return D2_D2Client_GetIsAutomapOpen_1_00();
}

mapi_bool32 D2_D2Client_GetIsAutomapOpen_1_00(void) {
  InitStatic();

  return *(mapi_bool32*) game_address.raw_address;
}

void D2_D2Client_SetIsAutomapOpen(
    int is_automap_open
) {
  InitStatic();
...
void D2_D2Client_SetIsAutomapOpen_1_00(
    mapi_bool32 is_automap_open
) {
  InitStatic();

  *(mapi_bool32*) game_address.raw_address = is_automap_open;
}
