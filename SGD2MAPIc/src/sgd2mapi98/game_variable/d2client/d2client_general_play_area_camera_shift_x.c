...
#include "../../../../include/sgd2mapi98/game_variable/d2client/d2client_general_play_area_camera_shift_x.h"
...
int D2_D2Client_GetGeneralPlayAreaCameraShiftX(void) {
  InitStatic();

  return D2_D2Client_GetGeneralPlayAreaCameraShiftX_1_00();
}

int32_t D2_D2Client_GetGeneralPlayAreaCameraShiftX_1_00(void) {
  InitStatic();

  return *(int32_t*) game_address.raw_address;
}

void D2_D2Client_SetGeneralPlayAreaCameraShiftX(
    int camera_shift_x
) {
  InitStatic();
...
void D2_D2Client_SetGeneralPlayAreaCameraShiftX_1_00(
    int32_t camera_shift_x
) {
  InitStatic();

  *(int32_t*) game_address.raw_address = camera_shift_x;
}
