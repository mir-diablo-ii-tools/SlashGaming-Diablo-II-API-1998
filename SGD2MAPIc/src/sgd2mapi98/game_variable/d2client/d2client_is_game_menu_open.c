...
#include "../../../../include/sgd2mapi98/game_variable/d2client/d2client_is_game_menu_open.h"
...
int D2_D2Client_GetIsGameMenuOpen(void) {
  InitStatic();

  return D2_D2Client_GetIsGameMenuOpen_1_00();
}

mapi_bool32 D2_D2Client_GetIsGameMenuOpen_1_00(void) {
  InitStatic();

  return *(mapi_bool32*) game_address.raw_address;
}

void D2_D2Client_SetIsGameMenuOpen(
    int is_game_menu_open
) {
  InitStatic();
...
void D2_D2Client_SetIsGameMenuOpen_1_00(
    mapi_bool32 is_game_menu_open
) {
  InitStatic();

  *(mapi_bool32*) game_address.raw_address = is_game_menu_open;
}
