...
#include "../../../../include/sgd2mapi98/game_variable/d2gfx/d2gfx_is_windowed_mode.h"
...
int D2_D2GFX_GetIsWindowedMode(void) {
  InitStatic();

  return D2_D2GFX_GetIsWindowedMode_1_00();
}

mapi_bool32 D2_D2GFX_GetIsWindowedMode_1_00(void) {
  InitStatic();

  return *(mapi_bool32*) game_address.raw_address;
}

void D2_D2GFX_SetIsWindowedMode(int is_window_mode) {
  InitStatic();

  D2_D2GFX_SetIsWindowedMode_1_00(is_window_mode);
}

void D2_D2GFX_SetIsWindowedMode_1_00(mapi_bool32 is_window_mode) {
  InitStatic();

  *(mapi_bool32*) game_address.raw_address = is_window_mode;
}
