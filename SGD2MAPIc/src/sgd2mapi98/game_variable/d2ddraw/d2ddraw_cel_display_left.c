...
#include "../../../../include/sgd2mapi98/game_variable/d2ddraw/d2ddraw_cel_display_left.h"
...
int D2_D2DDraw_GetCelDisplayLeft(void) {
  InitStatic();

  return D2_D2DDraw_GetCelDisplayLeft_1_00();
}

int32_t D2_D2DDraw_GetCelDisplayLeft_1_00(void) {
  InitStatic();

  return *(int32_t*) game_address.raw_address;
}

void D2_D2DDraw_SetCelDisplayLeft(int left) {
  InitStatic();

  D2_D2DDraw_SetCelDisplayLeft_1_00(left);
}

void D2_D2DDraw_SetCelDisplayLeft_1_00(int32_t left) {
  InitStatic();
