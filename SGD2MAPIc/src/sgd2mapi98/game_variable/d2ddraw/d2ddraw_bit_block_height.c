...
#include "../../../../include/sgd2mapi98/game_variable/d2ddraw/d2ddraw_bit_block_height.h"
...
int D2_D2DDraw_GetBitBlockHeight(void) {
  InitStatic();

  return D2_D2DDraw_GetBitBlockHeight_1_00();
}

int32_t D2_D2DDraw_GetBitBlockHeight_1_00(void) {
  InitStatic();

  return *(int32_t*) game_address.raw_address;
}

void D2_D2DDraw_SetBitBlockHeight(int height) {
  InitStatic();

  D2_D2DDraw_SetBitBlockHeight_1_00(height);
}

void D2_D2DDraw_SetBitBlockHeight_1_00(int32_t height) {
  InitStatic();
