...
#include "../../../../include/sgd2mapi98/game_variable/d2gdi/d2gdi_bit_block_width.h"
...
int D2_D2GDI_GetBitBlockWidth(void) {
  InitStatic();

  return D2_D2GDI_GetBitBlockWidth_1_00();
}

int32_t D2_D2GDI_GetBitBlockWidth_1_00(void) {
  InitStatic();

  return *(int32_t*) game_address.raw_address;
}

void D2_D2GDI_SetBitBlockWidth(int width) {
  InitStatic();

  D2_D2GDI_SetBitBlockWidth_1_00(width);
}

void D2_D2GDI_SetBitBlockWidth_1_00(int32_t width) {
  InitStatic();
