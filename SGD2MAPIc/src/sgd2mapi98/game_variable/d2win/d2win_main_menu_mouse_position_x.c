...
#include "../../../../include/sgd2mapi98/game_variable/d2win/d2win_main_menu_mouse_position_x.h"
...
int32_t D2_D2Win_GetMainMenuMousePositionX_1_00(void) {
  InitStatic();
...
void D2_D2Win_SetMainMenuMousePositionX_1_00(int32_t mouse_position_x) {
  InitStatic();
