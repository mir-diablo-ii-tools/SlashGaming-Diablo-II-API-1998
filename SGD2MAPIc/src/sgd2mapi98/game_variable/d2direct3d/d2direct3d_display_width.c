...
#include "../../../../include/sgd2mapi98/game_variable/d2direct3d/d2direct3d_display_width.h"
...
int D2_D2Direct3D_GetDisplayWidth(void) {
  InitStatic();

  return D2_D2Direct3D_GetDisplayWidth_1_00();
}

int32_t D2_D2Direct3D_GetDisplayWidth_1_00(void) {
  InitStatic();

  return *(int32_t*) game_address.raw_address;
}

void D2_D2Direct3D_SetDisplayWidth(int width) {
  InitStatic();

  D2_D2Direct3D_SetDisplayWidth_1_00(width);
}

void D2_D2Direct3D_SetDisplayWidth_1_00(int32_t width) {
  InitStatic();
