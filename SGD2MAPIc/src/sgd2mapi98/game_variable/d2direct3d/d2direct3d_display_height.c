...
#include "../../../../include/sgd2mapi98/game_variable/d2direct3d/d2direct3d_display_height.h"
...
int D2_D2Direct3D_GetDisplayHeight(void) {
  InitStatic();

  return D2_D2Direct3D_GetDisplayHeight_1_00();
}

int32_t D2_D2Direct3D_GetDisplayHeight_1_00(void) {
  InitStatic();

  return *(int32_t*) game_address.raw_address;
}

void D2_D2Direct3D_SetDisplayHeight(int height) {
  InitStatic();

  D2_D2Direct3D_SetDisplayHeight_1_00(height);
}

void D2_D2Direct3D_SetDisplayHeight_1_00(int32_t height) {
  InitStatic();
